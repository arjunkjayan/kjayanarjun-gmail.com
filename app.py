...
def register():
    if request.method == 'POST':
        ...
        user= Register(usr_name=usr_name,fname=fname,lname=lname,password=password,con_password=con_password,phone=phone,mail=mail,job=job,proof=proof
...
def Authority():
    if request.method == 'POST':
         fname = request.form['fname']
         lname = requset.form['lname']
         phone = request.form['phone']
         mail =request.form['mail']
         job = request.form['job']
         proof= request.form['proof']
         usr_name = request.form['usr_name']
         user = Authority(usr_name=usr_name,fname=fname,lname=lname,phone=phone,mail=mail,
                          job=job,proof=proof)
